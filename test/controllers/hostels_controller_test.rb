...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { address: @hostel.address, description: @hostel.description, name: @hostel.name, user_id: @hostel.user_id } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { address: @hostel.address, description: @hostel.description, name: @hostel.name, user_id: @hostel.user_id } }
