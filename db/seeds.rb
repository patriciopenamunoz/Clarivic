...
Ohiggins = Region.create(short_name: "Libertador General Bernardo O’Higgins", full_name: "Libertador General Bernardo O’Higgins")
...
Aisen = Region.create(short_name: "Aysén del General Carlos Ibáñez del Campo", full_name: "Aysén del General Carlos Ibáñez del Campo")
...
Commune.create(full_name: "Aysén", short_name: "Aysén", region: Aisen)
  ...
  10.times do |i|
    ...
    while [true, false].sample
      ...
      loop do
        ...
        room_type.number_rooms = rand(1..20)
