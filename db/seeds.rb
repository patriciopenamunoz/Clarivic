...
Ohiggins = Region.create(short_name: "Libertador Gral. Bernardo O’Higgins", full_name: "Libertador Gral. Bernardo O’Higgins")
...
Commune.create(full_name: "ConsVtución", short_name: "ConsVtución", region: Maule)
...
Commune.create(full_name: "ReVro", short_name: "ReVro", region: Maule)
...
Commune.create(full_name: "FruVllar", short_name: "FruVllar", region: Lagos)
...
Commune.create(full_name: "AntárVca", short_name: "AntárVca", region: Magallanes)
...
Commune.create(full_name: "TilVl", short_name: "TilVl", region: Metropolitana)
